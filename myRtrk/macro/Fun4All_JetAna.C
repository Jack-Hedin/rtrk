...
void Fun4All_JetAna(const int nEvents = 1,
                    const int segment = 0,
                    const std::string &filelistcalo = "lists/dst_calo_cluster.list",
                    const std::string &filelistglobal = "lists/dst_global.list",
                    const std::string &filelisttracks = "lists/dst_tracks.list",	   
                    const std::string &filelisttruthjet = "lists/dst_truth_jet.list",
                    const std::string &filelisttruth = "lists/dst_truth.list",
                    const std::string &outname = "Jet_R_Tracks_MC")
{
  ...
  std::string outputDir = "/sphenix/u/jackhedin/rtrk_project/myRtrk/macro/output/";
